...
<section class="admin_dashboard">
  ...
  <div class="admin_box_container">
    ...
    <div class="admin_box">
      <?php
        $total_completed = 0;
        $selectcompleted = mysqli_query($conn, "SELECT total_price FROM `order` WHERE payment_status = 'completed'") or die('query failed');
    ...
    <div class="admin_box">
      <?php
        $select_accounts=mysqli_query($conn,"SELECT * FROM `user`") or die('query failed');
